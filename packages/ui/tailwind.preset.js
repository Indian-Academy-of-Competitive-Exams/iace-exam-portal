  ...
  theme: {
    extend: {
      colors: {
        ...
        secondary: {
          DEFAULT: 'var(--secondary)', hover: 'var(--secondary-hover)',
        ...
        success: {
          DEFAULT: 'var(--success)', foreground: 'var(--success-foreground)',
          subtle: 'var(--success-subtle)', ink: 'var(--success-ink)',
        },
        warning: {
          DEFAULT: 'var(--warning)', foreground: 'var(--warning-foreground)',
          subtle: 'var(--warning-subtle)', ink: 'var(--warning-ink)',
        },
        info: {
          DEFAULT: 'var(--info)', foreground: 'var(--info-foreground)',
          subtle: 'var(--info-subtle)', ink: 'var(--info-ink)',
        },
        ...
        chart: { surface: 'var(--chart-surface)', grid: 'var(--chart-grid)', axis: 'var(--chart-axis)', ink: 'var(--chart-ink)' },

        // exam CBT palette (CBT screen only — separate from brand semantics)
        exam: {
          answered: 'var(--exam-answered)', notanswered: 'var(--exam-notanswered)',
          notvisited: 'var(--exam-notvisited)', marked: 'var(--exam-marked)',
        },
      },
      borderRadius: {
