...
/** The in-process event bus, typed against the catalog. FIRE AND FORGET: a producer publishes a fact that already happened, so a failing listener must not fail the request. */
@Injectable()
