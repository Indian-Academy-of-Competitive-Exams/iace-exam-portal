...
export class StorageService implements OnModuleDestroy {
  ...
  /** Reads an object back into memory. For a file the API itself uploaded and must re-read — an import committing the sheet it previewed — never for handing bytes to a browser, which gets a signed URL instead. */
